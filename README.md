...
首个正式版按 `1.0.0` 发布。GitHub Release 首屏只推荐下载安装器：
...
- 支持 `time.near`、变化摘要、diff、review clip 等视觉记忆/复核工具。
- Tray GUI 给人类保留暂停、允许、紧急停止、采集与保留设置、时间线和操作日志入口。
...
当前 canonical storage 是 MKV VFR：
...
- [v1.0.0 发布说明草稿](docs/release-notes-v1.0.0.md)
