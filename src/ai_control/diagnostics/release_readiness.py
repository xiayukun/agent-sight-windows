...
RELEASE_READINESS_SCHEMA = "ai_control_github_release_readiness_v1"
...
CORE_SOURCE_PATHS = [
    ...
    "README.en.md",
    "pyproject.toml",
    "src/ai_control/adapters/skill/SKILL.md",
...
def build_release_readiness_report(root: Path | str = ".") -> dict[str, Any]:
    ...
    return {
        "object_type": "AIControlGitHubReleaseReadinessReport",
...
def _publication_decision_template_inventory(workspace: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "path": rel,
        "exists": path.exists(),
        "schema_hint_present": "ai_control_publication_operator_decisions_v1" in text,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Inspect GitHub release readiness facts for AI-Control.")
