...
from ai_control.visual_memory.frame_buffer import VisualFrameBuffer


VISUAL_MEMORY_QUERY_SCHEMA = "ai_control_p0j_visual_memory_query_v1"
VISUAL_MEMORY_READING_SUMMARY_SCHEMA = "ai_control_p0j3_visual_memory_query_reading_summary_v1"
