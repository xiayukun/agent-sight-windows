...
from ai_control.channels.pointer_events import MOUSE_INPUT_TYPES, is_mouse_action, mouse_action_summary
...
def validate_post_observe(value: Any) -> dict[str, Any]:
    ...
    if not isinstance(frame_count, int) or frame_count < 1 or frame_count > 1000:
        raise SchemaError("post_observe.frame_count must be 1..1000", field="frame_count")
