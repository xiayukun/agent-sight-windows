...
from ai_control.channels.base import InputChannel, ObservationChannel
from ai_control.protocol.schemas import PAYLOAD_FIELDS, PUBLIC_COMMAND_ORDER
from ai_control.visual_memory.frame_buffer import FrameBufferConfig
    ...
    if field == "post_observe":
        return {
            ...
            "properties": {
                ...
                "frame_count": {"type": "integer", "minimum": 1, "maximum": 1000, "default": 3},
    ...
    def list_tools(self) -> dict[str, Any]:
        return {
            ...
            "tools": [
                {
                    "name": name,
                    "description": f"AI Control protocol command: {name}",
