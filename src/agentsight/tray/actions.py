...
def emergency_stop(reason: str, *, discovery_file: Path | None = None) -> dict[str, Any]:
    ...
    return {
        "object_type": "AgentSightTrayEmergencyStopReport",
        "schema": "agentsight_tray_emergency_stop_report_v1",
...
def clear_emergency() -> dict[str, Any]:
    ...
    return {
        "object_type": "AgentSightTrayClearEmergencyStopReport",
        "schema": "agentsight_tray_clear_emergency_stop_report_v1",
...
def pause_agentsight(reason: str = "operator_paused_agentsight") -> dict[str, Any]:
    ...
    status = load_tray_status()
    return {
        "object_type": "AgentSightTrayPauseAgentSightReport",
        "schema": "agentsight_tray_pause_agentsight_report_v1",
...
def allow_agentsight(reason: str = "operator_allowed_agentsight") -> dict[str, Any]:
    write_report = write_operator_control_policy(
    ...
    status = load_tray_status()
    return {
        "object_type": "AgentSightTrayAllowAgentSightReport",
        "schema": "agentsight_tray_allow_agentsight_report_v1",
...
def stop_agentsight(reason: str = "operator_requested_stop_agentsight_from_tray") -> dict[str, Any]:
    ...
    from agentsight.session_supervisor import stop_session_supervisor

    report = stop_session_supervisor(reason=reason, wait_seconds=2.0, force_after_timeout=True)
    return {
        "object_type": "AgentSightTrayStopAgentSightReport",
        "schema": "agentsight_tray_stop_agentsight_report_v1",
        "control_action": "stop_agentsight",
        "stop_semantics": {
