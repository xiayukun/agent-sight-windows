...
from agentsight.diagnostics.release_readiness import build_release_readiness_report
from agentsight.tray.state import boundary_facts, load_tray_status


AI_STATUS_SCHEMA = "agentsight_tray_ai_status_v1"
...
def ai_status_report(
    *,
    ...
    return {
        "object_type": "AgentSightTrayAIStatus",
        ...
        "ai_startup_sequence": [
            "Read agentsight-tray ai-status --caller-id <stable-id>.",
