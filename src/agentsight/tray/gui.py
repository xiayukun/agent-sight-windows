...
from agentsight.tray.actions import allow_agentsight, clear_emergency, emergency_stop, pause_agentsight, stop_agentsight
from agentsight.tray.hotkey import EmergencyHotkeyMonitor, build_hotkey_description
...
from agentsight.tray.timeline_viewer import launch_timeline_viewer_process


TRAY_GUI_SCHEMA = "agentsight_tray_gui_v1"
TRAY_RESIDENT_SCHEMA = "agentsight_tray_resident_v1"
TRAY_WINDOW_CLASS_NAME = "AgentSightTrayWindow"
RECORDING_SETTINGS_WINDOW_CLASS_NAME = "AgentSightRecordingSettingsWindow"
TRAY_ONLOGON_TASK_NAME = "AgentSightTrayOnLogon"
...
IDM_PAUSE_AGENTSIGHT = 1006
IDM_ALLOW_AGENTSIGHT = 1007
IDM_STOP_AGENTSIGHT = 1008
...
TRAY_MENU_ITEMS: tuple[dict[str, Any], ...] = (
    ...
    {"id": IDM_PAUSE_AGENTSIGHT, "key": "pause_agentsight", "label": "Pause AgentSight"},
    {"id": IDM_ALLOW_AGENTSIGHT, "key": "allow_agentsight", "label": "Allow AgentSight"},
    ...
    {"id": IDM_STOP_AGENTSIGHT, "key": "stop_agentsight", "label": "Stop AgentSight"},
)
...
TRAY_TEXT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "unknown": "Unknown",
        "pause_agentsight": "Pause AgentSight",
        "allow_agentsight": "Allow AgentSight",
        ...
        "language_zh": "中文",
        "language_en": "English",
        "stop_agentsight": "Stop AgentSight",
        "tray_title": "AgentSight",
    ...
    "zh": {
        ...
        "unknown": "未知",
        "pause_agentsight": "暂停 AI 控制",
        "allow_agentsight": "允许 AI 控制",
        "emergency_stop": "紧急停止",
...
def build_tray_gui_description() -> dict[str, Any]:
    windows = _is_windows()
    return {
        "object_type": "AgentSightTrayDescription",
        ...
        "controls": {
            "show_status": True,
            "pause_agentsight": True,
            "allow_agentsight": True,
            "emergency_stop": True,
            ...
            "stop_agentsight_full_shutdown": True,
        ...
        "stop_semantics": {
            ...
            "stop_agentsight": "full shutdown of Host Agent, Tray GUI, and Session Supervisor",
            "exit_tray_only": "removed from human menu because the Session Supervisor intentionally restarts the tray",
        },
        "recording_configuration": {
            "schema": "agentsight_tray_config_v1",
            ...
            "settings_dialog_model": "agentsight_recording_settings_dialog_v1",
            "idle_capture_default_fps": 0.1,
            "idle_capture_min_fps": 0.1,
            "action_capture_default_fps": 1,
            "action_capture_default_duration_ms": 10000,
            "action_capture_default_duration_seconds": 10,
            "action_capture_max_post_action_frames_required": False,
...
def _mb_to_gb_value(value: Any, *, default_mb: int) -> float | int:
    try:
        mb = float(value)
...
def _ms_to_seconds_value(value: Any, *, default_ms: int) -> float | int:
    try:
        ms = float(value)
    except (TypeError, ValueError):
        ms = float(default_ms)
...
def load_tray_settings() -> dict[str, Any]:
    ...
    if not path.exists():
        return {"schema": "agentsight_tray_settings_v1", "language": "system"}
    try:
    ...
    if language not in TRAY_LANGUAGE_OPTIONS:
        language = "system"
    return {"schema": "agentsight_tray_settings_v1", "language": language}
...
def save_tray_language(language: str) -> dict[str, Any]:
    ...
    data = {
        "schema": "agentsight_tray_settings_v1",
        "language": normalized,
...
def build_recording_settings_dialog_model(
    ...
    *,
    ...
    return {
        "object_type": "AgentSightRecordingSettingsDialogModel",
        "schema": "agentsight_recording_settings_dialog_v1",
        ...
        "controls": [
            ...
            },
            {
                ...
                "value": float(idle.get("fps") or 0.1),
                "min": 0.1,
                "max": 60,
                "unit": "fps",
            },
            ...
            },
            {
                ...
                "value": int(action.get("post_action_fps") or 1),
                "min": 1,
                "max": 60,
                "unit": "fps",
            },
            {
                ...
                "key": "post_action_duration_seconds",
                "field": "post_action_duration_seconds",
                "control_type": "float",
                "label": tray_text("setting_post_action_duration_ms", language=active_language),
                "value": _ms_to_seconds_value(action.get("post_action_duration_ms"), default_ms=10000),
                "min": 0.001,
                "max": 60,
                "unit": "seconds",
            },
            ...
            },
            {
                ...
                "value": _mb_to_gb_value(payload.get("max_storage_mb"), default_mb=5120),
                "min": 0.25,
                "max": 1024,
                "unit": "GB",
            },
            {
                ...
                "value": _mb_to_gb_value(payload.get("min_free_disk_mb"), default_mb=5120),
                "min": 0.25,
                "max": 1024,
                "unit": "GB",
            },
...
def build_tray_menu_model(status: dict[str, Any] | None = None, *, language: str | None = None) -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"kind": "item", "id": IDM_PAUSE_AGENTSIGHT, "key": "pause_agentsight", "label": tray_text("pause_agentsight", language=active_language), "enabled": can_pause},
        {"kind": "item", "id": IDM_ALLOW_AGENTSIGHT, "key": "allow_agentsight", "label": tray_text("allow_agentsight", language=active_language), "enabled": can_allow},
        {"kind": "separator"},
        ...
        {"kind": "separator"},
        {"kind": "item", "id": IDM_STOP_AGENTSIGHT, "key": "stop_agentsight", "label": tray_text("stop_agentsight", language=active_language), "enabled": True},
    ]
...
def build_tray_gui_run_report(
    *,
    ...
    return {
        "object_type": "AgentSightTrayRunReport",
        "schema": TRAY_GUI_SCHEMA,
...
def build_tray_gui_already_running_report(
    *,
    ...
    return {
        "object_type": "AgentSightTrayAlreadyRunningReport",
        "schema": TRAY_GUI_SCHEMA,
...
class Win32TrayApp:
    ...
    def _start_hotkey_monitor(self) -> None:
        if not self.enable_hotkey_monitor or not _is_windows():
            self.hotkey_start_report = {
                "object_type": "AgentSightTrayHotkeyMonitorStartReport",
                "schema": TRAY_GUI_SCHEMA,
    ...
    def _apply_recording_settings_window(self, hwnd: int) -> None:
        settings = {
            ...
            "post_action_duration_seconds": self._dialog_text(hwnd, IDM_RECORDING_POST_ACTION_DURATION_MS),
            "retention_days": self._dialog_text(hwnd, IDM_RECORDING_RETENTION_DAYS),
            "max_storage_gb": self._dialog_text(hwnd, IDM_RECORDING_MAX_STORAGE_MB),
            "min_free_disk_gb": self._dialog_text(hwnd, IDM_RECORDING_MIN_FREE_DISK_MB),
        }
        apply_recording_policy_settings(settings)
        self._refresh_icon()
    ...
    def _handle_command(self, command_id: int) -> None:
        if command_id == IDM_STATUS:
            self._show_status()
        elif command_id == IDM_PAUSE_AGENTSIGHT:
            pause_agentsight("operator_requested_from_tray_gui")
            self._refresh_icon()
        elif command_id == IDM_ALLOW_AGENTSIGHT:
            allow_agentsight("operator_requested_from_tray_gui")
            self._refresh_icon()
        ...
        elif command_id == IDM_STOP_AGENTSIGHT:
            report = stop_agentsight("operator_requested_stop_agentsight_from_tray_gui")
    ...
    def _message_box(self, text: str, *, title: str = "AgentSight") -> None:
        self.user32.MessageBoxW(self.hwnd, text, title, 0x40)


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="AgentSight Windows tray GUI.")
    ...
    try:
        ...
        report = {
            "object_type": "AgentSightTrayRunFailure",
            "schema": TRAY_GUI_SCHEMA,
...
def default_tray_resident_command_file() -> Path:
    return default_agent_dir() / "AgentSightTrayWatchdog.cmd"
...
def default_tray_resident_vbs_file() -> Path:
    ...
    return startup / "AgentSightTray.vbs"
...
def tray_gui_resident_status() -> dict[str, Any]:
    ...
    return {
        "object_type": "AgentSightTrayResidentStatus",
...
def install_tray_gui_resident(
    *,
    ...
    report: dict[str, Any] = {
        "object_type": "AgentSightTrayResidentInstallReport",
        "schema": TRAY_RESIDENT_SCHEMA,
...
def start_installed_tray_gui_resident(*, start_method: str = "auto", wait_seconds: float = 10.0) -> dict[str, Any]:
    ...
    if not vbs_file.exists() or not command_file.exists():
        return {
            "object_type": "AgentSightTrayResidentStartReport",
            "schema": TRAY_RESIDENT_SCHEMA,
...
def uninstall_tray_gui_resident(*, stop_running: bool = True) -> dict[str, Any]:
    ...
    stop_file.write_text("AgentSight tray watchdog stop requested.\n", encoding="utf-8")
    command_file = default_tray_resident_command_file()
    vbs_file = default_tray_resident_vbs_file()
    ...
    report = {
        "object_type": "AgentSightTrayResidentUninstallReport",
        "schema": TRAY_RESIDENT_SCHEMA,
...
def _tray_watchdog_report(
    *,
    ...
    return {
        "object_type": "AgentSightTrayWatchdogReport",
        "schema": TRAY_RESIDENT_SCHEMA,
...
def _tray_gui_child_command() -> list[str]:
    ...
    return [sys.executable, "-m", "agentsight.tray.gui", "run"]
...
def _tray_watchdog_command(*, repo_root: Path, python_command: str, tray_gui_exe: Path | None) -> str:
    ...
    return "\r\n".join(
        [
            ...
            f'cd /d "{repo_root}"',
            "set PYTHONPATH=src",
            f'"{python_command}" -m agentsight.tray.gui watchdog',
            "",
        ]
    )
...
def _default_adjacent_tray_gui_exe() -> Path | None:
    ...
    candidate = executable.with_name("AgentSightTray.exe")
