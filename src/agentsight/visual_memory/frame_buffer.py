...
from agentsight.evidence.store import EvidenceReplayService, canonical_json
...
class VisualFrameBuffer:
    ...
    schema = "agentsight_p0f_frame_buffer_v1"
    retention_schema = "agentsight_p0l_visual_memory_retention_v1"
    retention_class_schema = "agentsight_p0m_visual_memory_retention_class_projection_v1"
    storage_attention_summary_schema = "agentsight_p0n_visual_memory_storage_attention_summary_v1"
    ...
    def frames_near_time(self, requested_time: Any) -> dict[str, Any]:
        ...
        if parsed is None:
            return {
                ...
                "schema": "agentsight_p0_time_near_frame_query_v1",
