...
P0_ARMING_FLAG = "AGENTSIGHT_P0_REAL_INPUT_SMOKE"
    ...
    *,
    ...
    if not arming["armed"]:
        return {
            ...
            "suggested_next": [
                "set_AGENTSIGHT_P0_REAL_INPUT_SMOKE_armed_only_when_the_human_host_intends_real_input",
            ...
            "safe_report_lines": [
                ...
                "Set AGENTSIGHT_P0_REAL_INPUT_SMOKE=armed plus arming and consent refs only for an explicit host-side P0 smoke.",
            ],
        }
...
def _run_notepad_task(root: Path, *, host: "WindowsHostProbe", arming: dict[str, Any], launch_app: bool) -> dict[str, Any]:
    ...
    target_file = root / f"AgentSightP0Notepad-{uuid.uuid4().hex[:8]}.txt"
...
def _input_blocking_diagnosis(tasks: list[dict[str, Any]], environment: dict[str, Any]) -> dict[str, Any] | None:
    ...
    return {
        ...
        "suggested_next": [
            "run_real_input_through_a_resident_agentsight_host_agent_in_the_visible_interactive_user_session",
