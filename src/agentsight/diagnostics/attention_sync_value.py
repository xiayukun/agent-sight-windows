...
from agentsight.tray.state import boundary_facts, default_discovery_file, read_json_file


ATTENTION_SYNC_SCHEMA = "agentsight_attention_sync_value_proof_v1"
ATTENTION_VALUE_COMPARISON_SCHEMA = "agentsight_attention_value_comparison_v1"
    ...
    def _post(self, path: str, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        request = urllib.request.Request(
            ...
            headers={
                ...
                "X-AgentSight-Caller": self.caller_id,
...
def run_attention_sync_value_proof(
    *,
    ...
    report = {
        "object_type": "AgentSightAttentionSyncValueProof",
...
def run_attention_value_comparison(
    *,
    ...
    report = {
        "object_type": "AgentSightAttentionValueComparison",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--caller-id", default="agentsight-attention-sync-proof")
