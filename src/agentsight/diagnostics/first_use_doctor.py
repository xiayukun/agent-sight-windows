...
PYTHON_EXECUTABLE_OVERRIDE = "AGENTSIGHT_DOCTOR_PYTHON_EXECUTABLE"
...
def _capture_smoke_not_run() -> dict[str, Any]:
    return {
        ...
        "recommended_next": "run_first_use_doctor_with_capture_smoke_or_agentsight_capture_smoke",
        "install_executed": False,
        "input_executed": False,
        "background_action_executed": False,
    }
...
def _input_authorization_status(env: Mapping[str, str]) -> dict[str, Any]:
    ...
    if armed:
        ...
        recommended_next = "run_safe_dry_run_or_have_host_arm_agentsight_input_smoke"
    return {
        "state": state,
        ...
        "entrypoint": "agentsight-input-smoke",
...
def _first_use_commands(python_status: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "doctor_passive": f"{launcher} -m agentsight.diagnostics.first_use_doctor_cli",
        "doctor_with_capture_smoke": f"{launcher} -m agentsight.diagnostics.first_use_doctor_cli --capture-smoke",
        "capture_smoke_console": "agentsight-capture-smoke",
        ...
        "host_real_input_smoke_entrypoint": "agentsight-input-smoke",
        ...
        steps.append(
            {
                ...
                "suggested_command": "py -m agentsight.diagnostics.first_use_doctor_cli",
            }
        )
        ...
        steps.append(
            {
                ...
                "suggested_command": "agentsight-capture-smoke",
