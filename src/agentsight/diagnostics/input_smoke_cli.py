...
ARMING_FLAG = "AGENTSIGHT_REAL_INPUT_SMOKE"
ARMING_REF = "AGENTSIGHT_REAL_INPUT_ARMING_REF"
CONSENT_REF = "AGENTSIGHT_REAL_INPUT_CONSENT_REF"
ACTION = "AGENTSIGHT_INPUT_SMOKE_ACTION"
ACTION_X = "AGENTSIGHT_INPUT_SMOKE_X"
ACTION_Y = "AGENTSIGHT_INPUT_SMOKE_Y"
ACTION_BUTTON = "AGENTSIGHT_INPUT_SMOKE_BUTTON"
ACTION_TEXT = "AGENTSIGHT_INPUT_SMOKE_TEXT"
ACTION_KEY = "AGENTSIGHT_INPUT_SMOKE_KEY"
ACTION_MODIFIERS = "AGENTSIGHT_INPUT_SMOKE_MODIFIERS"
OBSERVATION_CHANNEL = "AGENTSIGHT_INPUT_SMOKE_OBSERVATION_CHANNEL"
REGION_X = "AGENTSIGHT_INPUT_SMOKE_REGION_X"
REGION_Y = "AGENTSIGHT_INPUT_SMOKE_REGION_Y"
REGION_WIDTH = "AGENTSIGHT_INPUT_SMOKE_REGION_WIDTH"
REGION_HEIGHT = "AGENTSIGHT_INPUT_SMOKE_REGION_HEIGHT"
POST_CAPTURE = "AGENTSIGHT_POST_ACTION_CAPTURE"
POST_CAPTURE_FRAME_COUNT = "AGENTSIGHT_POST_ACTION_FRAME_COUNT"
POST_CAPTURE_INTERVAL_MS = "AGENTSIGHT_POST_ACTION_INTERVAL_MS"
POST_CAPTURE_DELAY_MS = "AGENTSIGHT_POST_ACTION_DELAY_MS"
POST_CAPTURE_DURATION_MS = "AGENTSIGHT_POST_ACTION_DURATION_MS"
POST_CAPTURE_MEDIA_KIND = "AGENTSIGHT_POST_ACTION_MEDIA_KIND"
POST_CAPTURE_REGION_X = "AGENTSIGHT_POST_ACTION_REGION_X"
POST_CAPTURE_REGION_Y = "AGENTSIGHT_POST_ACTION_REGION_Y"
POST_CAPTURE_REGION_WIDTH = "AGENTSIGHT_POST_ACTION_REGION_WIDTH"
POST_CAPTURE_REGION_HEIGHT = "AGENTSIGHT_POST_ACTION_REGION_HEIGHT"
REPORT_PROFILE = "AGENTSIGHT_REPORT_PROFILE"
RUNS_DIR = "AGENTSIGHT_RUNS_DIR"
...
def _action_from_env(env: dict[str, str]) -> dict[str, Any]:
    ...
    try:
        ...
        return {"error": "mouse_click requires integer AGENTSIGHT_INPUT_SMOKE_X/Y"}
    button = env.get(ACTION_BUTTON, "left")
    if button not in {"left", "right"}:
...
def _observation_request_from_env(env: dict[str, str]) -> dict[str, Any]:
    ...
    if len(present) != len(region_keys):
        return {"error": "region observation requires all AGENTSIGHT_INPUT_SMOKE_REGION_X/Y/WIDTH/HEIGHT values"}
    try:
        region = {
            "x": int(env[REGION_X]),
            "y": int(env[REGION_Y]),
        ...
        return {"error": "region observation requires integer AGENTSIGHT_INPUT_SMOKE_REGION_X/Y/WIDTH/HEIGHT"}
